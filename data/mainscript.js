...
function safariIFrameWarning () {
	...
	if (isInIframe && /^((?!chrome|android).)*safari/i.test(navigator.userAgent)) {
		$(".iframewarning").html("Achtung: öffnen Sie die Seite bitte in einem eigenen Fenster, sonst funktioniert sie eventuell nicht! <a href='http://www.vvz.phil.tu-dresden.de/' target='_blank'>Klicken Sie dazu hier.</a>");
