...
class SqlFormatter
{
    ...
    public static $quote_attributes = 'class="blue_color"';
    public static $backtick_quote_attributes = 'class="purple_color"';
    public static $reserved_attributes = 'class="bold_text"';
    public static $boundary_attributes = '';
    public static $number_attributes = 'class="green"';
    public static $word_attributes = 'class="color_333"';
    public static $error_attributes = 'class="red_background"';
    public static $comment_attributes = 'class="color_aaa"';
    public static $variable_attributes = 'class="orange;"';
    public static $pre_attributes = 'class="black_white"';
