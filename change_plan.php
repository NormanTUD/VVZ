...
?>
	<div class="container">
		...
		<div class="plan_div <?php print get_kunde_plan() == "Pro" ? "chosen_plan" : 'possible_plan'; ?>">
			...
			<p>Nur eine Fakultät: <a href="?product=pro_university"><button class="buy_button"><i>80€/Monat -- oder -- 800€/Jahr</i></button></a></p>
			<p>Eine gesamte Universität: <a href="?product=pro_university"><button class="buy_button"><i>120€/Monat -- oder -- 1100€/Jahr</i></button></a></p>
		</div>
	</div>
