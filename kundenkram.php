<?php
	...
	function get_demo_expiry_time() {
		if(is_demo()) {
			...
			$str = "<br><span class='demo_string'>Diese Installation ist eine Demo. Das heißt: sie wird nach 7 Tagen gelöscht.<br>Ihnen verbleiben noch ".$ablauftimer." zum Testen.<br>Sie können die Adresse in der Adresszeile mit Ihren Kollegen teilen.<br>Der Standardnutzer ist <tt>Admin</tt>/<tt>test</tt></span><br>";
