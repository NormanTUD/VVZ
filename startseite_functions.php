...
?>
					<span class="display_none" data-studiengangid="<?php print htmlentities($this_studiengang[0] ?? ""); ?>" id="pn_modul_<?php print htmlentities($this_pruefungsnummer[6] ?? ""); ?>"><?php print htmlentities($this_modul[0] ?? ""); ?></span>
<?php
