...
<?php
			print export_crazy_ethik_export_format($chosen_pruefungsamt, $chosen_semester, get_get("einzelne_pns"), 1, get_get("last_changed_date"));
?>
			<form method="get" action="pruefungsleistungen_export.php">
